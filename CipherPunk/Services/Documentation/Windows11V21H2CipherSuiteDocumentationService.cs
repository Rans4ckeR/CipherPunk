...
internal static class Windows11V21H2CipherSuiteDocumentationService
{
    public static (WindowsVersion Version, List<WindowsDocumentationCipherSuiteConfiguration> Configurations) GetConfiguration()
        => (WindowsVersion.Windows11V21H2, [.. GetDefaultEnabledConfiguration(), .. GetDefaultDisabledConfiguration(), .. GetPreSharedKeyConfiguration()]);
    ...
    private static List<WindowsDocumentationCipherSuiteConfiguration> GetDefaultEnabledConfiguration()
        ...
        [
            ...
            new(SslProviderCipherSuiteId.TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, false, true, [SslProviderProtocolId.TLS1_2_PROTOCOL_VERSION]),
