...
internal static class Windows10V1511CipherSuiteDocumentationService
{
    public static (WindowsSchannelVersion Version, List<WindowsDocumentationCipherSuiteConfiguration> Configurations) GetConfiguration()
        => (WindowsSchannelVersion.Windows10V1511, [.. GetDefaultEnabledConfiguration(), .. GetDefaultDisabledConfiguration()]);
    ...
    private static List<WindowsDocumentationCipherSuiteConfiguration> GetDefaultDisabledConfiguration()
        => new()
        {
            ...
            new(SslProviderCipherSuiteId.SSL_CK_DES_64_CBC_WITH_MD5, false, false, [SslProviderProtocolId.SSL2_PROTOCOL_VERSION]),
