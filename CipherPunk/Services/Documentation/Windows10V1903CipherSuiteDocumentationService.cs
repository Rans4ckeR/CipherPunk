...
internal static class Windows10V1903CipherSuiteDocumentationService
{
    public static KeyValuePair<WindowsVersion, FrozenSet<WindowsDocumentationCipherSuiteConfiguration>> GetConfiguration()
        => new(WindowsVersion.Windows10V1903, FrozenSet.ToFrozenSet([.. GetDefaultEnabledConfiguration(), .. GetDefaultDisabledConfiguration(), .. GetPreSharedKeyConfiguration()]));
    ...
    private static FrozenSet<WindowsDocumentationCipherSuiteConfiguration> GetDefaultEnabledConfiguration()
        ...
        [
            ...
            new(5, SslProviderCipherSuiteId.TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, false, true, [SslProviderProtocolId.TLS1_2_PROTOCOL_VERSION]),
